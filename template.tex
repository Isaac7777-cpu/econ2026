...
\usepackage{geometry}
\usepackage{setspace}
\geometry{left=0.3in, right=0.3in, top=0.75in, bottom=0.75in}
...
\begin{titlepage}
  \centering
  \vspace*{1in} % Adjust the vertical spacing as needed

  \Huge
  \textbf{Money and Banking Lecutre 3}

  \vspace{0.5in}

  \LARGE
  Interest rate, Yield Curves, Expectation Theory, Liquidity Premium Theory, Segmented Market Theory
  ...
  % Or use a specific date if preferred:
  % \Large
  % \textbf{Day, Month Date, Year}

  \vspace{0.8in}

  % Optional: Add institution or affiliation
  \Large
